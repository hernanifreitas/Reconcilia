...
public class BankMovementParamViewModel : ViewModelBase<ReCrossEntities, MovementParam, MovementParamCollection>
{
	...
	protected override void InitilizeCustomDataCollections()
	{
		...
		EntityCVS.Source = base.CurrentDataContext.Entities.OfType<BankEntity>().ToList();
